...
const baseStyles = {
  ...
  h3: 'font-inter text-[#383247] text-[16px] md:text-[18px] leading-[20px] md:leading-[32px]',
  h4: 'font-inter text-[#696969] text-[14px] md:text-[16px] leading-[20px] md:leading-[24px]',
  h5: 'font-anekLatin text-[#242424] text-[16px] md:text-[20px] leading-[24px] md:leading-[30px] font-bold mb-2 md:mb-1',
  h6: 'font-inter text-[#FFFDF8] text-[16px] md:text-[20px] font-normal',
  p: 'font-anek text-[14px] leading-[24px] text-desc mb-4',
  p_guiest: "font-inter text-[16px] sm:text-[18px] md:text-[20px] leading-[26px] sm:leading-[30px] md:leading-[32px] max-w-[600px] mb-6 sm:mb-8 text-[#FFFFFF94]",
